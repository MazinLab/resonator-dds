...
//------------------------Local signal-------------------
    ...
    wire                          int_tones_ce0;
    wire                          int_tones_we0;
    wire [31:0]                   int_tones_be0;
    wire [255:0]                  int_tones_d0;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            rdata <= int_tones_q1 >> (int_tones_shift * 32);
        end
    end
end
...
assign int_tones_we0      = 1'b0;
assign int_tones_be0      = 1'b0;
assign int_tones_d0       = 1'b0;
...
assign int_tones_we1      = int_tones_write & WVALID;
assign int_tones_be1      = WSTRB << (waddr[4:2] * 4);
