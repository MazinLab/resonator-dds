...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_56_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_65_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_74_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_83_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_92_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_101_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_110_acc;
...
wire   [21:0] grp_phase_to_sincos_wLUT_fu_119_acc;
...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp18 = ((ap_start == 1'b0) & (ap_start == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp20 = ((ap_start == 1'b0) & (ap_start == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp22 = ((ap_start == 1'b0) & (ap_start == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp32 = ((ap_start == 1'b0) & (ap_start == 1'b1));
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0_ignore_call3 = (ap_start == 1'b0);
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0_ignore_call7 = (ap_start == 1'b0);
end
...
assign grp_phase_to_sincos_wLUT_fu_101_acc = {{accg[131:110]}};

assign grp_phase_to_sincos_wLUT_fu_110_acc = {{accg[153:132]}};

assign grp_phase_to_sincos_wLUT_fu_119_acc = {{accg[175:154]}};

assign grp_phase_to_sincos_wLUT_fu_56_acc = accg[21:0];

assign grp_phase_to_sincos_wLUT_fu_65_acc = {{accg[43:22]}};

assign grp_phase_to_sincos_wLUT_fu_74_acc = {{accg[65:44]}};

assign grp_phase_to_sincos_wLUT_fu_83_acc = {{accg[87:66]}};

assign grp_phase_to_sincos_wLUT_fu_92_acc = {{accg[109:88]}};
