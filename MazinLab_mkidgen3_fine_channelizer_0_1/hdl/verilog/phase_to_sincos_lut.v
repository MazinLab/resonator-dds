...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module phase_to_sincos_lut_rom (
...
initial begin
    $readmemh("./phase_to_sincos_lut_rom.dat", ram0);
    $readmemh("./phase_to_sincos_lut_rom.dat", ram1);
    $readmemh("./phase_to_sincos_lut_rom.dat", ram2);
    $readmemh("./phase_to_sincos_lut_rom.dat", ram3);
end
...
phase_to_sincos_lut_rom phase_to_sincos_lut_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
