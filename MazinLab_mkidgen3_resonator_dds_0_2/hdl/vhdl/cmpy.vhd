...
architecture behav of cmpy is 
    ...
    signal empty_21_fu_637_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_21_reg_1045 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    resonator_dds_mulg8j_U39 : component resonator_dds_mulg8j
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 17,
    ...
    resonator_dds_mulg8j_U40 : component resonator_dds_mulg8j
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 17,
    ...
    resonator_dds_machbi_U41 : component resonator_dds_machbi
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 17,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_ce_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                empty_21_reg_1045 <= empty_21_fu_637_p2;
    ...
    empty_21_fu_637_p2 <= (xor_ln786_2_fu_626_p2 or icmp_ln790_5_fu_632_p2);
    ...
    sum2_V_fu_197_p3 <= 
        ...
        ret_V_3_reg_829;
    tmp1_fu_711_p2 <= (xor_ln781_2_fu_705_p2 and empty_21_reg_1045);
