...
wire   [9:0] cos_lut_V_address0;
reg    cos_lut_V_ce0;
wire   [16:0] cos_lut_V_q0;
wire   [9:0] cos_lut_V_address1;
reg    cos_lut_V_ce1;
wire   [16:0] cos_lut_V_q1;
wire   [8:0] fine_lut_V_address0;
reg    fine_lut_V_ce0;
wire   [15:0] fine_lut_V_q0;
...
wire   [16:0] trunc_ln790_16_fu_201_p1;
reg   [16:0] trunc_ln790_16_reg_972;
...
reg   [0:0] p_Result_s_15_reg_1060;
reg   [0:0] p_Result_s_15_reg_1060_pp0_iter9_reg;
reg   [0:0] p_Result_s_15_reg_1060_pp0_iter10_reg;
reg   [0:0] p_Result_s_15_reg_1060_pp0_iter11_reg;
...
reg   [0:0] tmp_112_reg_1130;
reg   [0:0] tmp_112_reg_1130_pp0_iter11_reg;
reg   [0:0] p_Result_2_reg_1136;
reg   [0:0] p_Result_2_reg_1136_pp0_iter11_reg;
wire   [14:0] trunc_ln790_17_fu_550_p1;
reg   [14:0] trunc_ln790_17_reg_1142;
wire   [0:0] r_1_fu_554_p2;
reg   [0:0] r_1_reg_1147;
wire   [0:0] icmp_ln790_5_fu_559_p2;
reg   [0:0] icmp_ln790_5_reg_1152;
wire   [15:0] p_Val2_13_fu_602_p2;
reg   [15:0] p_Val2_13_reg_1157;
reg   [15:0] p_Val2_13_reg_1157_pp0_iter12_reg;
reg   [0:0] tmp_118_reg_1163;
reg   [0:0] tmp_118_reg_1163_pp0_iter12_reg;
reg   [0:0] p_Result_5_reg_1169;
reg   [0:0] p_Result_5_reg_1169_pp0_iter12_reg;
wire   [14:0] trunc_ln790_18_fu_624_p1;
reg   [14:0] trunc_ln790_18_reg_1175;
wire   [15:0] select_ln340_33_fu_735_p3;
reg   [15:0] select_ln340_33_reg_1180;
wire   [0:0] icmp_ln790_6_fu_743_p2;
reg   [0:0] icmp_ln790_6_reg_1185;
reg    ap_block_pp0_stage0_subdone;
wire   [63:0] zext_ln544_fu_166_p1;
wire   [63:0] zext_ln544_2_fu_175_p1;
wire   [63:0] zext_ln544_3_fu_244_p1;
...
wire   [31:0] trunc_ln4_fu_452_p3;
wire   [0:0] tmp_109_fu_499_p3;
wire   [0:0] tmp_111_fu_511_p3;
wire   [0:0] or_ln412_fu_506_p2;
wire   [0:0] and_ln415_fu_518_p2;
wire   [15:0] p_Val2_6_fu_490_p4;
wire   [15:0] zext_ln415_fu_524_p1;
wire   [0:0] tmp_115_fu_573_p3;
wire   [0:0] tmp_117_fu_585_p3;
wire   [0:0] or_ln412_30_fu_580_p2;
wire   [0:0] and_ln415_2_fu_592_p2;
wire   [15:0] zext_ln415_16_fu_598_p1;
...
wire   [0:0] xor_ln785_5_fu_660_p2;
...
wire   [0:0] xor_ln340_5_fu_709_p2;
wire   [0:0] or_ln340_11_fu_703_p2;
wire   [0:0] or_ln340_12_fu_715_p2;
wire   [15:0] select_ln340_5_fu_721_p3;
wire   [15:0] select_ln388_5_fu_728_p3;
wire   [0:0] xor_ln416_1_fu_748_p2;
wire   [0:0] carry_3_fu_753_p2;
wire   [0:0] xor_ln779_1_fu_758_p2;
wire   [0:0] xor_ln781_fu_770_p2;
wire   [0:0] xor_ln785_7_fu_780_p2;
...
wire   [0:0] empty_16_fu_807_p2;
wire   [0:0] or_ln781_1_fu_775_p2;
wire   [0:0] tmp46_fu_812_p2;
wire   [0:0] underflow_3_fu_818_p2;
wire   [0:0] overflow_1_fu_790_p2;
wire   [0:0] xor_ln340_6_fu_829_p2;
wire   [0:0] or_ln340_13_fu_823_p2;
wire   [0:0] or_ln340_14_fu_835_p2;
wire   [15:0] select_ln340_6_fu_841_p3;
wire   [15:0] select_ln388_6_fu_848_p3;
wire   [15:0] select_ln340_34_fu_855_p3;
wire   [15:0] grp_fu_874_p1;
...
resonator_dds_muleOg #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 18 ),
    .dout_WIDTH( 34 ))
resonator_dds_muleOg_U2(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_885_p0),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        p_Result_s_15_reg_1060 <= grp_fu_874_p3[32'd43];
        ...
        tmp_112_reg_1130 <= p_Val2_8_fu_528_p2[32'd15];
        tmp_112_reg_1130_pp0_iter11_reg <= tmp_112_reg_1130;
        tmp_118_reg_1163 <= p_Val2_13_fu_602_p2[32'd15];
...
assign add_ln713_fu_473_p2 = (trunc_ln4_fu_452_p3 + trunc_ln1192_1_reg_1084);

assign and_ln415_2_fu_592_p2 = (tmp_117_fu_585_p3 & or_ln412_30_fu_580_p2);

assign and_ln415_fu_518_p2 = (tmp_111_fu_511_p3 & or_ln412_fu_506_p2);
...
assign ap_return_0 = select_ln340_33_reg_1180;

assign ap_return_1 = select_ln340_34_fu_855_p3;
...
assign cos_lut_V_address0 = zext_ln544_fu_166_p1;

assign cos_lut_V_address1 = zext_ln544_2_fu_175_p1;
...
assign deleted_ones_fu_643_p3 = ((carry_1_fu_633_p2[0:0] === 1'b1) ? xor_ln779_fu_638_p2 : p_Result_s_15_reg_1060_pp0_iter11_reg);

assign empty_16_fu_807_p2 = (xor_ln786_1_fu_801_p2 | icmp_ln790_6_reg_1185);

assign empty_fu_687_p2 = (xor_ln786_fu_681_p2 | icmp_ln790_5_reg_1152);

assign fine_lut_V_address0 = zext_ln544_3_fu_244_p1;

assign grp_fu_874_p1 = zext_ln1118_fu_396_p1;

assign grp_fu_885_p0 = zext_ln1118_fu_396_p1;

assign icmp_ln790_5_fu_559_p2 = ((trunc_ln790_17_reg_1142 == 15'd0) ? 1'b1 : 1'b0);

assign icmp_ln790_6_fu_743_p2 = ((trunc_ln790_18_reg_1175 == 15'd0) ? 1'b1 : 1'b0);
...
assign or_ln340_11_fu_703_p2 = (underflow_2_fu_698_p2 | overflow_fu_670_p2);

assign or_ln340_12_fu_715_p2 = (xor_ln340_5_fu_709_p2 | overflow_fu_670_p2);

assign or_ln340_13_fu_823_p2 = (underflow_3_fu_818_p2 | overflow_1_fu_790_p2);

assign or_ln340_14_fu_835_p2 = (xor_ln340_6_fu_829_p2 | overflow_1_fu_790_p2);

assign or_ln412_30_fu_580_p2 = (tmp_115_fu_573_p3 | r_1_reg_1147);

assign or_ln412_fu_506_p2 = (tmp_109_fu_499_p3 | r_reg_1089);

assign or_ln781_1_fu_775_p2 = (xor_ln781_fu_770_p2 | tmp_118_reg_1163_pp0_iter12_reg);

assign or_ln781_fu_655_p2 = (xor_ln781_2_fu_650_p2 | tmp_112_reg_1130_pp0_iter11_reg);

assign or_ln785_1_fu_785_p2 = (xor_ln785_7_fu_780_p2 | p_Result_5_reg_1169_pp0_iter12_reg);

assign or_ln785_fu_665_p2 = (xor_ln785_5_fu_660_p2 | p_Result_2_reg_1136_pp0_iter11_reg);
...
assign p_Val2_13_fu_602_p2 = (zext_ln415_16_fu_598_p1 + p_Val2_12_fu_564_p4);

assign p_Val2_6_fu_490_p4 = {{ret_V_reg_1053_pp0_iter9_reg[42:27]}};

assign p_Val2_8_fu_528_p2 = (p_Val2_6_fu_490_p4 + zext_ln415_fu_524_p1);

assign p_Val2_s_fu_347_p3 = ((and_ln879_4_fu_342_p2[0:0] === 1'b1) ? zext_ln879_fu_260_p1 : select_ln879_5_fu_329_p3);

assign r_1_fu_554_p2 = ((trunc_ln718_1_reg_1113 != 26'd0) ? 1'b1 : 1'b0);

assign r_V_1_fu_195_p2 = (18'd0 - zext_ln203_fu_179_p1);

assign r_V_fu_185_p2 = (18'd0 - zext_ln203_1_fu_182_p1);

assign r_fu_433_p2 = ((trunc_ln718_reg_1068 != 26'd0) ? 1'b1 : 1'b0);

assign ret_V_1_fu_459_p2 = ($signed(rhs_V_1_fu_449_p1) + $signed(sext_ln728_1_fu_445_p1));

assign rhs_V_1_fu_449_p1 = r_V_3_reg_1079;

assign select_ln340_33_fu_735_p3 = ((or_ln340_12_fu_715_p2[0:0] === 1'b1) ? select_ln340_5_fu_721_p3 : select_ln388_5_fu_728_p3);

assign select_ln340_34_fu_855_p3 = ((or_ln340_14_fu_835_p2[0:0] === 1'b1) ? select_ln340_6_fu_841_p3 : select_ln388_6_fu_848_p3);

assign select_ln340_5_fu_721_p3 = ((or_ln340_11_fu_703_p2[0:0] === 1'b1) ? 16'd32767 : p_Val2_8_reg_1124_pp0_iter11_reg);

assign select_ln340_6_fu_841_p3 = ((or_ln340_13_fu_823_p2[0:0] === 1'b1) ? 16'd32767 : p_Val2_13_reg_1157_pp0_iter12_reg);

assign select_ln340_fu_225_p3 = ((underflow_fu_220_p2[0:0] === 1'b1) ? 18'd131073 : r_V_reg_957);

assign select_ln388_5_fu_728_p3 = ((underflow_2_fu_698_p2[0:0] === 1'b1) ? 16'd32769 : p_Val2_8_reg_1124_pp0_iter11_reg);

assign select_ln388_6_fu_848_p3 = ((underflow_3_fu_818_p2[0:0] === 1'b1) ? 16'd32769 : p_Val2_13_reg_1157_pp0_iter12_reg);
...
assign tmp46_fu_812_p2 = (or_ln781_1_fu_775_p2 & empty_16_fu_807_p2);

assign tmp_109_fu_499_p3 = ret_V_reg_1053_pp0_iter9_reg[32'd27];

assign tmp_111_fu_511_p3 = ret_V_reg_1053_pp0_iter9_reg[32'd26];

assign tmp_115_fu_573_p3 = ret_V_1_reg_1094_pp0_iter10_reg[32'd27];

assign tmp_117_fu_585_p3 = add_ln713_reg_1108_pp0_iter10_reg[32'd26];
...
assign trunc_ln4_fu_452_p3 = {{trunc_ln1192_reg_1032_pp0_iter8_reg}, {25'd0}};

assign trunc_ln718_1_fu_478_p1 = ret_V_1_fu_459_p2[25:0];

assign trunc_ln718_fu_420_p1 = grp_fu_874_p3[25:0];

assign trunc_ln790_16_fu_201_p1 = r_V_1_fu_195_p2[16:0];

assign trunc_ln790_17_fu_550_p1 = p_Val2_8_fu_528_p2[14:0];

assign trunc_ln790_18_fu_624_p1 = p_Val2_13_fu_602_p2[14:0];

assign trunc_ln790_fu_191_p1 = r_V_fu_185_p2[16:0];

assign underflow_1_fu_232_p2 = ((trunc_ln790_16_reg_972 == 17'd0) ? 1'b1 : 1'b0);

assign underflow_2_fu_698_p2 = (tmp_fu_692_p2 & p_Result_s_15_reg_1060_pp0_iter11_reg);
...
assign xor_ln340_5_fu_709_p2 = (underflow_2_fu_698_p2 ^ 1'd1);

assign xor_ln340_6_fu_829_p2 = (underflow_3_fu_818_p2 ^ 1'd1);

assign xor_ln416_1_fu_748_p2 = (tmp_118_reg_1163_pp0_iter12_reg ^ 1'd1);

assign xor_ln416_fu_628_p2 = (tmp_112_reg_1130_pp0_iter11_reg ^ 1'd1);

assign xor_ln779_1_fu_758_p2 = (p_Result_3_reg_1100_pp0_iter12_reg ^ 1'd1);

assign xor_ln779_fu_638_p2 = (p_Result_s_15_reg_1060_pp0_iter11_reg ^ 1'd1);
...
assign xor_ln785_5_fu_660_p2 = (p_Result_s_15_reg_1060_pp0_iter11_reg ^ carry_1_fu_633_p2);

assign xor_ln785_7_fu_780_p2 = (p_Result_3_reg_1100_pp0_iter12_reg ^ carry_3_fu_753_p2);
...
assign zext_ln415_16_fu_598_p1 = and_ln415_2_fu_592_p2;

assign zext_ln415_fu_524_p1 = and_ln415_fu_518_p2;

assign zext_ln544_2_fu_175_p1 = sin_adr_V_reg_910;

assign zext_ln544_3_fu_244_p1 = p_Result_s_reg_892_pp0_iter3_reg;
...
endmodule //phase_to_sincos_wLUT
