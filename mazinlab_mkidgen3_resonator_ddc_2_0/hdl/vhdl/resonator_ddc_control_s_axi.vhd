...
entity resonator_ddc_control_s_axi is
generic (
...
end entity resonator_ddc_control_s_axi;
...
architecture behave of resonator_ddc_control_s_axi is
    ...
    component resonator_ddc_control_s_axi_ram is
        generic (
    ...
    end component resonator_ddc_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_tones
int_tones : resonator_ddc_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 32,
...
port map (
     ...
     q1        => int_tones_q1);
-- int_centers
int_centers : resonator_ddc_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 32,
...
entity resonator_ddc_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity resonator_ddc_control_s_axi_ram;

architecture behave of resonator_ddc_control_s_axi_ram is
